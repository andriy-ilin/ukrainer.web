...
import CatalogArticles from "./pages/CatalogArticles";
import CatalogShopItems from "./pages/CatalogShopItems";
    ...
    return (
      <Layout>
        <Router>
          ...
          <CatalogArticles path="/catalog-articles" />
          <CatalogShopItems path="/catalog-shop-items" />
          <Team path="/team" />
          <Video path="/video" />
